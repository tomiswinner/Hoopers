  ...
  describe "GET /index" do
    ...
    describe '時間検索機能' do
      before do
        ...
        [Time.new(2022,01,01,07,00),
         Time.new(2022,01,01,08,00),
         Time.new(2022,01,01,09,00)].each do |open_time|
          [Time.new(2022,01,01,10,00),
           Time.new(2022,01,01,11,00),
           Time.new(2022,01,01,12,00)].each do |close_time|
            FactoryBot.create(:event, open_time: open_time, close_time: close_time, court_id: 1, user_id: 0)
          end
        end
      end
